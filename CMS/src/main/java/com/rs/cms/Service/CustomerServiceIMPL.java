...
import com.rs.cms.CustomerRepo.CustomerRepo;
...
public class CustomerServiceIMPL implements CustomerService {
	...
	public List<CustomerDTO> getAllCustomer() {
		...
		for (Customer a : getCustomers) {
			CustomerDTO customerDTO = new CustomerDTO(a.getCustomerid(), a.getCustomername(), a.getCustomeraddress(),
					a.getMobile());
	...
	public String updateCustomer(CustomerUpdateDTO customerUpdateDTO) {
		if (customerRepo.existsById(customerUpdateDTO.getCustomerid())) {
			...
			System.out.println("customer ID don not Exist");
		}
